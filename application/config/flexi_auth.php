...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['join'] = 'user_accounts.user_id';
	$config['database']['user_acc']['columns']['id'] = 'user_id';
	$config['database']['user_acc']['columns']['group_id'] = 'group_fk';
	$config['database']['user_acc']['columns']['email'] = 'email';
	$config['database']['user_acc']['columns']['username'] = 'username'; 
	$config['database']['user_acc']['columns']['password'] = 'password';
	$config['database']['user_acc']['columns']['ip_address'] = 'ip_address';
	$config['database']['user_acc']['columns']['salt'] = 'salt';
	$config['database']['user_acc']['columns']['activation_token'] = 'activation_token';
	$config['database']['user_acc']['columns']['forgot_password_token'] = 'forgotten_password_token';
	$config['database']['user_acc']['columns']['forgot_password_expire'] = 'forgotten_password_expire';
	$config['database']['user_acc']['columns']['update_email_token'] = 'update_email_token';
	$config['database']['user_acc']['columns']['update_email'] = 'update_email';
	$config['database']['user_acc']['columns']['active'] = 'active';
	$config['database']['user_acc']['columns']['suspend'] = 'suspend';
	$config['database']['user_acc']['columns']['failed_logins'] = 'fail_login_attempts';
	$config['database']['user_acc']['columns']['failed_login_ip'] = 'fail_login_ip_address';
	$config['database']['user_acc']['columns']['failed_login_ban_date'] = 'date_fail_login_ban';
	$config['database']['user_acc']['columns']['last_login_date'] = 'date_last_login';
	$config['database']['user_acc']['columns']['date_added'] = 'date_added';
	...
	*/ 
	$config['database']['settings']['identity_cols'] = array('email', 'username');
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('email');
	...
	*/
	$config['security']['static_salt'] = 'JdGPa5F2Nybs1FsLqL2duVl71Gw16awI';
	...
	*/
	$config['security']['login_attempt_time_ban'] = 60*3;
	...
	*/
	$config['email']['email_template_directory'] = 'email/';
