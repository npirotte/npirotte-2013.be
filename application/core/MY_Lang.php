...
class MY_Lang extends CI_Lang {
  ...
  /**************************************************
   configuration
  ***************************************************/
  public function GetLanguages($cultures)
  {
    $languages = explode('|', $cultures);
    $output = array();
  ...
  function MY_Lang()
  {
    ...
    $this->languages = $this->GetLanguages(CULTURES);
    ...
    if ($this->uri == '') // special URI -> no redirect
    { 
  ...
  {
    if ((!empty($lang_code)) && (in_array($lang_code, $this->special))  || preg_match($this->admin_exclude, $lang_code) )
      return TRUE;
    else
      return FALSE;
  }
