admin.directive('managerUserInfos', ['usersRespository', function(usersRespository){
	// Runs during compile
	return {
		// name: '',
		// priority: 1,
		...
		controller: function($scope, $element, $attrs, $transclude) {
			console.log(usersRespository);
			usersRespository.userInfos($scope.userId, function(data)
				{
					$scope.user = data;
...
admin.directive('serveUsage', ['$http', function($http){
	// Runs during compile
	return {
		// name: '',
		// priority: 1,
