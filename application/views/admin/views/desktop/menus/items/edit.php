	...
	<div class="col-sm-6 col-sm-offset-1">
	  ...
	  <form name="itemForm" class="form form-horizontal" ng-submit="save(true)">
	  	...
	  	<div class="form-group">
	        ...
	        <div class="col-xs-6">
	          <?php print_input($self, 'text', 'menus_items', 'name', 'item', 'itemForm') ?>
	        </div>
	    </div>
	    ...
	    <div class="form-group" ng-show="item.module && item.module != 'toto' && item.module != 'url'">
	        <label class="control-label col-xs-3">Fonctions</label>
	        <div class="col-xs-6">
	    ...
	    <div class="form-group" ng-show="item.module && item.function || item.module === 'url'">
	        ...
	        <div class="col-xs-6">
	          	<select ui-select2 name="type" ng-model='item.element' ng-if="item.module != 'url'">
				...
				<div ng-if="item.module === 'url'">
					<?php print_input($self, 'text', 'menus_items', 'element', 'item', 'itemForm') ?>
				</div>
	        </div>
	    </div>
